...
const projectsData = [
  {
    ...
    description:
      'Full-stack application for managing academic progress, featuring database integration and external API synchronization.',
  ...
  },
  {
    ...
    description:
      'Whimsical weather utility leveraging external APIs and LLM integration to deliver personalized, AI-driven weather insights.',
  ...
  },
  {
    ...
    description:
      'Interactive digital calendar based on the traditional Māori lunar Maramataka (Work in Progress).',
  ...
  },
  {
    ...
    description:
      'Automated JavaScript utility for bulk comment management via browser developer tools.',
